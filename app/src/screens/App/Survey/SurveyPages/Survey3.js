        ...
        >
            ...
            <View style={{ width: '100%', alignItems: 'center', marginTop: 30 }}>
                <View style={{ width: '40%', height: 10, backgroundColor: 'white', borderRadius: 10 }}>
                    <View style={{width:'33%', backgroundColor: '#1C4B90', height: '100%', borderRadius: 10 }}></View>
                </View>
            </View>
            <View style={{ flex: 1, justifyContent: 'space-between' }}>
                <View style={{ marginTop: 30, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ marginTop: 10, marginBottom:40, fontFamily: 'Poppins_600SemiBold', fontSize: 34, lineHeight: 51, color: 'white', justifyContent: 'flex-start', textAlign: 'center' }}>¿Cuantas veces intentaste dejar de fumar?</Text>
                    <ScrollView contentContainerStyle={{alignItems: 'center'}} style={{ width: '80%'}}>
                        <TouchableOpacity onPress={() => navigation.navigate("Survey4")} style={{ alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderRadius: 62, borderColor: 'white', height: 62, width: '100%' }}>
                            <Text style={{ fontFamily: 'Poppins_600SemiBold', color: 'white', fontSize: 20, lineHeight: 30 }}>
                            Nunca lo intenté
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate("Survey4")} style={{ marginTop: 15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderRadius: 62, borderColor: 'white', height: 62, width: '100%' }}>
                            <Text style={{ fontFamily: 'Poppins_600SemiBold', color: 'white', fontSize: 20, lineHeight: 30 }}>
                            1 Vez
                            </Text>
                        </TouchableOpacity>
